...
void __predictor_printBasicStatistics(int score_only, int csv){
    ...
    if (score_only) {
        ...
        printf("Branches, Unique Branches, Unique Branches %%, Taken, "
               ...
               "Predicted wrong %%\n");
        printf("%8lu, %8lu, %8.4f, %8lu, %8.4f, %8lu, %8.4f, %8lu, %8.4f, "
               "%8lu, %8.4f, %8lu, %8.4f, %8lu, %8.4f\n",
        ...
        printf("Predictor:                                 %s\n", _predictor_name);
        printf("Tracefile:                                 %s\n", _filename);
        printf("Total No of Branches:                      %9lu\n", counter);
        printf("No of Unique Branches:                     %9lu\n", e.pos);
//        printf("Taken:               %8lu  %8.4f%%\n", taken, d_taken);
//        printf("Predicted Taken:     %8lu  %8.4f%%\n", pt, d_pt);
//        printf("Not taken:           %8lu  %8.4f%%\n", nottaken, d_nottaken);
//        printf("Predicted Non-Taken: %8lu  %8.4f%%\n", pnt, d_pnt);
        printf("No of Branches Correctly predicted:         %8lu\n", hits);
        printf("No of Branches incorrectly predicted:       %8lu\n", miss);
        printf("Miss Prediction Rate:                       %8.4f%%\n", d_miss);
	printf("\n");
    }
...
void predictor_printAdvancedStatistics(int csv) {
    ...
    for (size_t i = 0; i < e.pos; i++) {
        ...
        if (csv) {
            printf("%10u, %8lu, %8lu, %8.4f, %8lu, %8.4f, %8lu, %8.4f, "
                   "%8lu, %8.4f, %8lu, %8.4f, %8lu, %8.4f\n",
            ...
            printf(" %8lu %6.2f%% |", counter, d_counter);
            printf(" %8lu %6.2f%% |", taken, d_taken);
            printf(" %8lu %6.2f%% |", pt, d_pt);
            printf(" %8lu %6.2f%% |", nottaken, d_nottaken);
            printf(" %8lu %6.2f%% |", pnt, d_pnt);
            printf(" %8lu %6.2f%% |", hits, d_hits);
            printf(" %8lu %6.2f%% |", miss, d_miss);
            printf("\n");
	}
    }
