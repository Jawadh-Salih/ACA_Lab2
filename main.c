    ...
    while ((c = getopt(argc, argv, "hi:abcstfr123456x:k:n:")) != -1) {
        switch(c) {
            ...
            case '1':
                ...
                predictor_name = "single_bit_predictor";
                break;
            case '2':
                prediction_algorithm = '2';
                predictor_name = "two_bit_predictor";
                break;
            case '3':
                prediction_algorithm = '3';
                predictor_name = "two_two_bit_predictor";
                break;
            case '4':
                prediction_algorithm = '4';
                predictor_name = "custom_predictor";
                break;
            case '5':
